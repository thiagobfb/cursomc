...
import com.thiagobernardo.cursomc.domain.Pagamento;
import com.thiagobernardo.cursomc.domain.PagamentoComBoleto;
import com.thiagobernardo.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "thiagobf.barbosa@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, encoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "madguitar777@gmail.com", "42977727604", TipoCliente.PESSOAFISICA, encoder.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("998733231", "33219008"));
		
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "38172010", cli2, c1);
